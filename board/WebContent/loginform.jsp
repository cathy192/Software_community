...
<body style="background-color:#880015;" id="page-top">
    ...
    <div class="container">
    <h2 style="margin-top:100px;" class="page-section-heading text-center text-uppercase text-white">REGISTER</h2>
...
<form style="margin-top:100px; margin-left:250px; margin-right:250px; margin-bottom:100px" action ="/board/join.do" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <h4 style="color:white">School ID</h4>
      <input type="text" class="form-control" id="inputPassword4" placeholder="School ID" name="Snum">
    </div>
  </div>
  <div class="form-group">
    <h4 style="color:white">ID</h4>
    <input type="text" class="form-control" id="inputAddress" placeholder="ID" name="id">
  </div>
  <div class="form-group">
    <h4 style="color:white">Pass word</h4>
    <input type="password" class="form-control" id="inputAddress2" placeholder="Pass word" name="password">
  </div>
  <input type="submit" class="btn btn-outline-primary" value="Register" Onclick="login.do;">
